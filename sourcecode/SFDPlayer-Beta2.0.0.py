 ...
 if os.path.isfile(ffmpeg_exe_path):
  ...
  ffmpeg_location_int.set(1)
   ...
   if ffmpegmissing_message:
    ...
    master.title("SFDPlayer Beta 1.0.0 (PREVIEW MODE)")
...
master = tk.Tk()
master.geometry("300x130"), master.title("SFDPlayer Beta 2.0.0"), master.resizable(False, False)#, master.iconbitmap("resource/icon/sfdplayer.ico")
