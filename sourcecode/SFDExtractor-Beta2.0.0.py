 ...
 if os.path.isfile(ffmpeg_exe_path):
  ...
  ffmpeg_location_int.set(1)
   ...
   if ffmpegmissing_message:
    ...
    master.title("SFDExtractor Beta 2.0.0 (PREVIEW MODE)")


master = tk.Tk()
master.geometry("600x300"), master.title("SFDExtractor Beta 2.0.0"), master.resizable(False, False)#, master.iconbitmap("resource/icon/sfdextractor.ico")
