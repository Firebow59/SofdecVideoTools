 ...
 if os.path.isfile(ffmpeg_exe_path):
  ...
  ffmpeg_location_int.set(1)
   ...
   if ffmpegmissing_message:
    ...
    master.title("SFDExtractor Beta 2.0.2 (PREVIEW MODE)")


master = tk.Tk()
master.geometry("600x300"), master.title("SFDExtractor Beta 2.0.2"), master.resizable(False, False)#, master.iconbitmap("resource/icon/sfdextractor.ico")
...
def advancedoptions():
  ...
  optwin.geometry("600x300"), optwin.title("Extra Options"), optwin.resizable(False, False)
  ...
  QoLsettingsframe = LabelFrame(optwin, text="QoL Settings").place(relx=0.010, rely=0.455, relheight=0.490, relwidth=0.390)
  miscsettingsframe = LabelFrame(optwin, text="Misc. Program Settings").place(relx=0.417, rely=0.455, relheight=0.490, relwidth=0.313)
  ...
  crfentry.insert(0, "")
  crfentry.place(x=198, y=40)
  crflbl = Label(optwin, text="CRF Value:", font=("Arial Bold", 8)).place(x=195, y=20)
  ...
  vbitrateentry.place(x=293, y=40)
  vbitratelbl = Label(optwin, text="Video Bitrate:", font=("Arial Bold", 8)).place(x=290, y=20)
  ...
  abitrateentry.place(x=388, y=40)
  abitratelbl = Label(optwin, text="Audio Bitrate:", font=("Arial Bold", 8)).place(x=385, y=20)
  ...
  videoencoderbox.place(x=483, y=40)
  videoencoderbox.current(0)
  videoencoderbox.state(["readonly"])
  videoencoderlbl = Label(optwin, text="Video Codec:", font=("Arial Bold", 8)).place(x=480, y=20)
  ...
  vres.place(x=197, y=95)
  vres.current(0)
  videoreslabel = Label(optwin, text="Video Resolution:", font = ("Arial Bold", 8)).place(x=195, y=75.2)
  ...
  useidenticaldirectorypaths.place(x=11, y=156)
  ...
  deleteoriginalsfdcheck = ttk.Checkbutton(optwin, text='Delete SFD after extraction', variable=deleteoriginalsfd, onvalue=1, offvalue=0).place(x=255, y=156)
  #runfromoriginalfile = ttk.Checkbutton(optwin, text="Don't copy SFD (use original)", variable=useoriginalsfd, onvalue=1, offvalue=0).place(x=255, y=176)
  disablevideoreencode = ttk.Checkbutton(optwin, text="Don't re-encode video", variable=copyvideocodec, onvalue=1, offvalue=0).place(x=255, y=176) #.place(x=255, y=196)
